...
module tb_myip_v1_0(
	...
	reg [width-1:0] test_input_memory [0:NUMBER_OF_TEST_VECTORS*NUMBER_OF_INPUT_WORDS-1];				// 467 inputs * number of test vectors
	reg [width-1:0] test_result_expected_memory [0:NUMBER_OF_TEST_VECTORS*NUMBER_OF_OUTPUT_WORDS-1];	// 64 outputs * number of test vectors
           ...
           begin
				...
				begin
            		...
            		begin
                		...
                		$display("Mismatch at %0d: got %0h, expected %0h", word_cnt, result_memory[word_cnt], test_result_expected_memory[word_cnt]);
            		end
				end
				
				
				$display("Complete. Number of incorrect entries: %0d.", failure_cnt);	
				$finish;
           end
endmodule